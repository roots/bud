---
description: Modify the project babel transform options.
---

# bud.babel

Modify the babel transform options used in your project. For more information [refer to the documentation on babel's website](https://babeljs.io/docs/en/presets).
