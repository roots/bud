...
describe(suite.name, () => {
  ...
  describe('production', () => {
    ...
    describe('runtime', () => {
      ...
      it('is transpiled', () => {
        expect(
          assets['runtime.js'].includes('import'),
        ).toBeFalsy()
      })
    })
    ...
    describe('editor', () => {
      ...
      it('is transpiled', () => {
        expect(
          assets['editor.js'].includes('import'),
        ).toBeFalsy()
      })
      it('css: has contents', () => {
      ...
      it('css: @tailwind directive is transpiled', () => {
        expect(assets['editor.css'].includes('@apply')).toBe(
          false,
        )
      })
      it('css: has whitespace removed', () => {
    ...
    describe('customizer', () => {
      it('has contents', () => {
        expect(assets['customizer.js'].length).toBeGreaterThan(
          10,
        )
      })
      it('is transpiled', () => {
