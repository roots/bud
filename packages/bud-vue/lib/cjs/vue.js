...
var vueTemplateCompiler = createCommonjsModule(function (module, exports) {
...
var deindent = _interopDefault(deIndent__default['default']);

var he = _interopDefault(he__default['default']);
/*  */
...
function observe(value, asRootData) {
  ...
  if (hasOwn(value, '__ob__') && value.__ob__ instanceof Observer) {
    ob = value.__ob__;
  } else if ( !isServerRendering() && (Array.isArray(value) || isPlainObject(value)) && Object.isExtensible(value) && !value._isVue) {
...
function model$1(el, dir, _warn) {
  ...
  if (el.component) {
    ...
    warn$2('<' + el.tag + ' v-model="' + value + '">: ' + 'v-model is not supported on this element type. ' + "If you are working with contenteditable, it's recommended to " + 'wrap a library dedicated for that purpose inside a custom component.', el.rawAttrsMap['v-model']);
