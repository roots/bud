...
import ImageMinimizerPlugin, { PluginOptions } from 'image-minimizer-webpack-plugin/types';
...
export declare namespace Imagemin {
    ...
    interface Plugin extends WebpackPlugin<ImageMinimizerPlugin, PluginOptions> {
...
export declare const name: "@roots/bud-imagemin", api: Module.Api, register: Module.Register, boot: Module.Boot;
