import { Extensions as Contract, Framework, Module, Service } from '@roots/bud-framework';
import { Extension } from '../Extension';
declare class Extensions extends Service<Framework.Extensions> implements Contract {
    name: string;
