...
> Adds [**@tailwindlabs/tailwindcss**](https://github.com/tailwindlabs/tailwindcss) support to [**@roots/bud**](https://github.com/roots/bud/tree/stable/packages/@roots/bud) projects.
...
If you need a tailwindcss config file to get started with you may also pull one into your project with the [`bud publish` command](https://github.com/roots/bud/tree/stable/docs/cli.md).
