...
declare type BudCriticalCssPlugin = WebpackPlugin<
...
export declare const name: string | number,
  ...
  make: import('@roots/bud-framework/types/Module').Module.Make<
    ...
    import('@roots/critical-css-webpack-plugin').Options
  >,
  when: import('@roots/bud-framework/types/Module').Module.When<
    import('@roots/critical-css-webpack-plugin').Options
  >,
  api: import('@roots/bud-framework/types/Module').Module.Api
export {}
