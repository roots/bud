...
declare class Bud extends Framework {
   ...
   * @returns bud
   */
  addPlugin: Bud.Config.AddPlugin
...
declare namespace Bud {
  ...
  export namespace Build {
    ...
    export type Entry = (bud: Bud) => Product.Entry
    export type Externals = (bud: Bud) => Product.Externals
    export type Module = (bud: Bud) => Product.Module
    export type Resolve = (bud: Bud) => Product.Resolve
    export type Optimization = (bud: Bud) => Product.Optimization
    export type Plugins = (bud: Bud) => Product.Plugins
    export type Output = (bud: Bud) => Product.Output
    export type General = (bud: Bud) => Product.General
