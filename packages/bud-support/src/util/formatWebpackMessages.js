...
const isLikelySyntaxError = (message) => message.indexOf(friendlySyntaxErrorLabel) !== -1;
const filterSyntaxErrors = (errors) => errors.some(isLikelySyntaxError)
...
const formatMessage = (message) => {
    ...
    lines.length > 2 &&
        ...
        lines.splice(1, 1);
    return [
        chalk_1.default `{bgRed.whiteBright  ${lines[0]
            .split(/ \(/)[0]
            .replace('./', '')} } `
            .concat(lines[1]
            .replace('Error:', '')
