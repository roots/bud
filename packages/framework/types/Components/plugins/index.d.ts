...
declare const _default: {
    ...
    gzip: typeof gzip;
    cleanWebpack: typeof cleanWebpack;
    copy: import("../../types/Extension").Extension.Factory;
    define: import("../../types/Extension").Extension.Factory;
    dll: import("../../types/Extension").Extension.Factory;
    dllReference: import("../../types/Extension").Extension.Factory;
    ...
    terser: import("../../types/Extension").Extension.Factory;
    writeFile: import("../../types/Extension").Extension.Factory;
    watchMissingModules: import("../../types/Extension").Extension.Factory;
};
