...
var Debug = function (_a) {
    ...
    return (react_1["default"].createElement(ink_1.Box, { display: isFocused && ((_b = config === null || config === void 0 ? void 0 : config.features) === null || _b === void 0 ? void 0 : _b.debug) ? 'flex' : 'none', flexDirection: "column" },
        react_1["default"].createElement(ink_1.Text, null, cli_highlight_1["default"](JSON.stringify({ config: config }, null, 4)))));
};
exports.Debug = Debug;
Debug.propTypes = {
