import { Handler, Application as Express, Handler as ExpressHandler } from 'express';
...
declare class Server implements Server.Interface {
    ...
    constructor(compiler?: Server.Interface['compiler'], config?: Server.Interface['config']);
