...
var sync = function (_a) {
    ...
    this.options.set('browsersync', tslib.__assign(tslib.__assign({}, this.options.get('browsersync')), options));
    return this;
};
...
const browserSync$1 = browserSyncLibrary.create();
...
var bootstrap = function () {
     ...
     */
    this.framework.options.set('browserSync', this.framework.options.get('browsersync')(this.framework.flags));
