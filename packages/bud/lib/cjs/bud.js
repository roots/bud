...
var browserSyncLibrary = require('browser-sync');
...
var browserSyncLibrary__default = /*#__PURE__*/_interopDefaultLegacy(browserSyncLibrary);
...
var babel = function (options) {
    ...
    this.options.set('babel', this.hooks.filter('api.babel', tslib.__assign(tslib.__assign({}, this.options.get('babel')), { plugins: this.hooks.filter('api.babel.plugins', tslib.__spreadArrays(this.options.get('babel.plugins'), ((_a = options.plugins) !== null && _a !== void 0 ? _a : []))), presets: this.hooks.filter('api.babel.presets', tslib.__spreadArrays(this.options.get('babel.presets'), ((_b = options.presets) !== null && _b !== void 0 ? _b : []))) })));
    return this;
};
...
var dist = function (path$1) {
    return path$1
        ? path.join(this.paths.get('dist'), path$1)
        : this.paths.get('dist');
};
...
var hot = function (options) {
    ...
    var chokidarHandler = (_b = options === null || options === void 0 ? void 0 : options.chokidar) !== null && _b !== void 0 ? _b : {
        before: function (app, server) {
            var _a;
            chokidar__default['default'].watch((_a = options === null || options === void 0 ? void 0 : options.watch) !== null && _a !== void 0 ? _a : []).on('all', function () {
...
var project = function (path$1) {
    return path$1
        ? path.join(this.paths.get('project'), path$1)
...
const makeMiddleware = (bud, setDevStats) => {
  ...
  const devMiddleware = webpackDevMiddleware__default['default'](bud.compiler, devMiddlewareOptions);
  const hotMiddleware = webpackHotMiddleware__default['default'](bud.compiler, {
    reload: false,
    heartbeat: 2000
  });
...
const useFocusState = useStore(React__default['default'], {
  assets: true,
  debug: false,
  devServer: false,
  errors: false,
...
const Bullet = ({
  active
}) => /*#__PURE__*/React__default['default'].createElement(ink.Text, null, active ? '◉' : ' ');
...
const Nav = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    ...
    color: '#545DD7'
  }, "@roots/bud")), /*#__PURE__*/React__default['default'].createElement(ink.Spacer, null), /*#__PURE__*/React__default['default'].createElement(ink.Spacer, null), /*#__PURE__*/React__default['default'].createElement(ink.Spacer, null), /*#__PURE__*/React__default['default'].createElement(ink.Box, null, /*#__PURE__*/React__default['default'].createElement(ink.Text, {
    color: (focused === null || focused === void 0 ? void 0 : focused.assets) ? 'white' : '#6C758F'
  }, /*#__PURE__*/React__default['default'].createElement(Bullet, {
    active: focused === null || focused === void 0 ? void 0 : focused.assets
  }), " Assets")), /*#__PURE__*/React__default['default'].createElement(ink.Spacer, null), /*#__PURE__*/React__default['default'].createElement(ink.Box, null, /*#__PURE__*/React__default['default'].createElement(ink.Text, {
  ...
  }), " Errors", (build === null || build === void 0 ? void 0 : (_build$errors2 = build.errors) === null || _build$errors2 === void 0 ? void 0 : _build$errors2.length) > 0 && build.errors[0] ? ` [${build.errors.length}]` : `  `)), /*#__PURE__*/React__default['default'].createElement(ink.Spacer, null), /*#__PURE__*/React__default['default'].createElement(ink.Box, null, /*#__PURE__*/React__default['default'].createElement(ink.Text, {
  ...
  }), " Dev server"))), bud.features.enabled('browserSync') && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(ink.Spacer, null), /*#__PURE__*/React__default['default'].createElement(ink.Box, null, /*#__PURE__*/React__default['default'].createElement(ink.Text, {
  ...
  }), " BrowserSync"))), bud.features.enabled('debug') && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(ink.Spacer, null), /*#__PURE__*/React__default['default'].createElement(ink.Box, null, /*#__PURE__*/React__default['default'].createElement(ink.Text, {
...
Nav.propTypes = {
  build: PropTypes__default['default'].object,
  focused: PropTypes__default['default'].object,
  bud: PropTypes__default['default'].object
};

const BLACKLIST_PROPS = ['percent', 'left', 'right', 'columns', 'character', 'rightPad'];

class Bar extends React__default['default'].Component {
  getString() {
    const {
      percent,
      columns,
  ...
  render() {
    const props = blacklist__default['default'](this.props, BLACKLIST_PROPS);
    return /*#__PURE__*/React__default['default'].createElement(ink.Text, props, this.getString());
  }
...
Bar.propTypes = {
  ...
  character: PropTypes__default['default'].string,
  rightPad: PropTypes__default['default'].bool
};
...
const Loading = ({
  ...
  return (build === null || build === void 0 ? void 0 : build.percentage) > 0 && (build === null || build === void 0 ? void 0 : build.percentage) < 1 ? /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    maxWidth: width,
    textWrap: "truncate",
    flexDirection: "row"
    ...
    width: 6
  }, Math.round((build === null || build === void 0 ? void 0 : build.percentage) * 100), "%", (build === null || build === void 0 ? void 0 : build.percentage) < 1 ? '  ' : ' ')), /*#__PURE__*/React__default['default'].createElement(ink.Text, {
    color: '#545DD7'
...
const BuildInfo = ({
  ...
  paddingTop: 1
}, (build === null || build === void 0 ? void 0 : build.percentage) == 1 && (build === null || build === void 0 ? void 0 : build.hash) && /*#__PURE__*/React__default['default'].createElement(ink.Text, {
  color: "#6C758F",
  marginTop: 1
}, "Build ", build === null || build === void 0 ? void 0 : build.hash, ". Finished in ", (build === null || build === void 0 ? void 0 : build.time) / 1000, "s."), /*#__PURE__*/React__default['default'].createElement(Loading, {
  build: build,
  width: width
}));
...
const App = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    ...
    focused: focused || {},
    bud: bud
  }), children, /*#__PURE__*/React__default['default'].createElement(ink.Spacer, null), /*#__PURE__*/React__default['default'].createElement(BuildInfo, {
    build: build,
    width: width
  }));
};
...
App.propTypes = {
  ...
  state: PropTypes__default['default'].object,
  build: PropTypes__default['default'].object,
  bud: PropTypes__default['default'].object,
  width: PropTypes__default['default'].number,
...
Indicator.propTypes = {
  emitted: PropTypes__default['default'].bool
};
/**
 * Asset
 *
...
const Asset = ({
  ...
  return !display ? [] : /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    flexDirection: "row",
    justifyContent: "space-between"
  }, /*#__PURE__*/React__default['default'].createElement(ink.Box, null, /*#__PURE__*/React__default['default'].createElement(Indicator, {
    emitted: asset.emitted
  }), /*#__PURE__*/React__default['default'].createElement(ink.Text, {
    color: asset.emitted ? 'white' : 'gray'
  }, asset.name)), /*#__PURE__*/React__default['default'].createElement(ink.Spacer, null), /*#__PURE__*/React__default['default'].createElement(ink.Box, null, /*#__PURE__*/React__default['default'].createElement(ink.Text, {
    dimColor: "white"
  }, asset.size / 1000, "kb")));
};

Asset.propTypes = {
  asset: PropTypes__default['default'].object
};
/**
 * Assets
 *
...
const Assets = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    ...
    flexDirection: "column"
  }, build === null || build === void 0 ? void 0 : (_build$assets = build.assets) === null || _build$assets === void 0 ? void 0 : _build$assets.map((asset, id) => /*#__PURE__*/React__default['default'].createElement(Asset, {
    key: id,
    asset: asset
  })), (build === null || build === void 0 ? void 0 : (_build$assets2 = build.assets) === null || _build$assets2 === void 0 ? void 0 : _build$assets2.length) == 0 && /*#__PURE__*/React__default['default'].createElement(ink.Text, null, "Loading"));
};
...
const BrowserSync = ({
  ...
  patchConsole__default['default']((stream, data) => {
    setLastConsole(data);
  ...
  return /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    display: isFocused ? 'flex' : 'none',
    flexDirection: "column"
  }, /*#__PURE__*/React__default['default'].createElement(ink.Text, null, consoleOut));
};
...
const Error$1 = ({
  ...
  React.useEffect(() => {
    message && notifier__default['default'].notify({
      title: 'Build error',
      message
    });
  }, [message]);
...
const Errors = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    ...
    flexDirection: "column"
  }, (build === null || build === void 0 ? void 0 : build.errors) && build.errors.length > 0 && build.errors.map((err, i) => /*#__PURE__*/React__default['default'].createElement(Error$1, {
    message: err,
    key: i
  })), (build === null || build === void 0 ? void 0 : (_build$warnings = build.warnings) === null || _build$warnings === void 0 ? void 0 : _build$warnings.length) == 0 && /*#__PURE__*/React__default['default'].createElement(ink.Text, null, "Nothing to see here."));
};
...
const Warning = ({
  ...
  return !message ? [] : /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    paddingLeft: 1,
    paddingRight: 1,
    flexDirection: "column"
  }, /*#__PURE__*/React__default['default'].createElement(ink.Text, {
...
const DevServer = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    display: isFocused ? 'flex' : 'none',
    flexDirection: "column"
  }, /*#__PURE__*/React__default['default'].createElement(ink.Text, null, build === null || build === void 0 ? void 0 : build.devServer));
};
...
const Runner = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(App, {
    ...
    state: state,
    bud: bud
  }, /*#__PURE__*/React__default['default'].createElement(Assets, {
    width: width,
    actions: actions,
    build: build
  }), /*#__PURE__*/React__default['default'].createElement(Errors, {
    actions: actions,
    build: build
  }), /*#__PURE__*/React__default['default'].createElement(Warnings, {
    actions: actions,
    build: build
  }), showBrowserSync && /*#__PURE__*/React__default['default'].createElement(BrowserSync, {
    actions: actions
  }), /*#__PURE__*/React__default['default'].createElement(DevServer, {
    actions: actions,
    build: build
  }));
};
...
Runner.propTypes = {
  compiler: PropTypes__default['default'].object,
  bud: PropTypes__default['default'].object
};
...
var renderCompilerDashboard = function (bud, webpackConfig) {
    bud.compiler = bud.features.enabled('hot')
        ? webpack__default['default'](injectHot({
        ...
        : webpack__default['default'](webpackConfig);
    bud.logger.info({
        name: 'bud.compiler',
    }, "compiler attached to bud");
    var props = { bud: bud };
    var application = React__default['default'].createElement(Runner, props);
    /** 🚀 */
...
var controller = function (bud, extension) { return ({
    ...
    mergeExtensionOptions: function () {
        ...
        if (this.boundValue) {
            this.extension.options = tslib.__assign(tslib.__assign({}, this.extension.options), this.boundValue);
        }
        delete this.boundValue;
    },
    /**
