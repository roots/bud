...
var useHotSyncServer_1 = require("./useHotSyncServer");
/**
 * Hook: useWebpack
 *
 * @prop {Bud} bud
...
var useWebpack = function (bud) {
     ...
     */
    var _c = react_1.useState({}), build = _c[0], setBuild = _c[1];
    ...
    var _k = useHotSyncServer_1.useHotSyncServer(bud, webpackCallback), hotSyncServer = _k[0], devStats = _k[1];
    /**
