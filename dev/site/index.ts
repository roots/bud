...
writeFileSync(
  ...
  execa.sync('yarn', ['bud', 'build', '--hash'], {
    cwd: `${process.cwd()}/examples/babel`,
  }).stdout,
  {encoding: 'utf8'},
)
...
writeFileSync(
  ...
  (() => {
    ...
    return execa.sync('yarn', ['bud', 'build', '--cache'], {
      cwd: `${process.cwd()}/examples/babel`,
    }).stdout
  })(),
  {encoding: 'utf8'},
...
writeFileSync(
  ...
  execa.sync('yarn', ['bud', 'build', '--help'], {
    cwd: `${process.cwd()}/examples/babel`,
  }).stdout,
  {encoding: 'utf8'},
)
...
writeFileSync(
  ...
  execa.sync('yarn', ['bud', 'extensions', '--help'], {
    cwd: `${process.cwd()}/examples/babel`,
  }).stdout,
  {encoding: 'utf8'},
)
...
writeFileSync(
  ...
  execa.sync('yarn', ['bud', 'extensions:install', '--help'], {
    cwd: `${process.cwd()}/examples/babel`,
  }).stdout,
  {encoding: 'utf8'},
)
...
writeFileSync(
  ...
  execa.sync('yarn', ['bud', 'clean', '--help'], {
    cwd: `${process.cwd()}/examples/babel`,
  }).stdout,
  {encoding: 'utf8'},
)
