<template>
  <svg class="logo" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 81 77" version="1.1">
    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g transform="translate(1.000000, 1.000000)" stroke="white">
        ...
        <polygon id="Path" points="39.4 51.4 38.9 51 26.4 41.9 31.2 27.2 31.4 26.6 47.4 26.6 52.4 41.9 41.3 50">
        </polygon>
        <polygon id="Path" points="72.5 36.1 67 43.6 58.1 40.7 52.7 24.2 58.2 16.6 67.1 19.5 72.5 36.1"></polygon>
        <polygon id="Path" points="30.8 5.7 48.1 5.7 53.6 13.3 52.8 14.4 48.1 20.9 30.7 20.9 26 14.3 25.3 13.3">
        </polygon>
