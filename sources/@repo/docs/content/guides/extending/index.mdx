...
We recommend authoring bud extensions with ES Modules.
...
Include a `bud` field to mark the module as an extension. This field will be
...
Last requirement is to export your extension as the `default` export from an `./extension` export:
