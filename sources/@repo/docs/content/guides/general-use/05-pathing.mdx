...
slug: pathing
sidebar_label: Referencing paths
sidebar_position: 5
---

You might consider using **bud.path** to easily reference a file or directory's absolute path:
...
## Adding or modifying **bud.path** handles
...
**bud.alias** is a helper function for creating aliases. Unlike paths, aliases may be used in your application scripts.
