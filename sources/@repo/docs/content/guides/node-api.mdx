...
**bud.js** is designed to be used as a CLI tool but it is possible to use it in NodeJS directly. This makes it easier to:
...
Call `bud.build.make` and return the configuration.
