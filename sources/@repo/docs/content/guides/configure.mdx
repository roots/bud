...
- The config file is **not** required. If your root entrypoint is **@src/index.js** and you have no particular build requirements, it might be enough to install bud and whatever extensions and be done with it.
...
`ctrl+c` will terminate the application gracefully.
