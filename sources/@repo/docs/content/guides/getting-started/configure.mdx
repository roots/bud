...
This requires the installation of an extension that provides TypeScript support such as [@roots/bud-swc](/extensions/bud-swc), [@roots/bud-esbuild](/extensions/bud-esbuild) or [@roots/bud-typescript](/extensions/bud-typescript).
