...
The typings for the `Bud` object in **bud.js** have been consolidated under a single interface/namespace: `Bud`. If you are using [@roots/bud-typescript], please update your config file and any type declarations to use `Bud` instead of `Framework`.
