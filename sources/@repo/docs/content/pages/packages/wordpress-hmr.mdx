...
```ts
import {load} from '@roots/wordpress/blocks'
...
You can adjust the directory (`./blocks`) and matcher for default filename (the regular expression).
