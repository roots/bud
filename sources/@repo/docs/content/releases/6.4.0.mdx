...
Lots of fixes, features, and performance improvements. As always, you can read enhanced release notes at [bud.js.org](https://bud.js.org/blog/6.4.0).

<!--truncate-->

:::info Updates available

There are patches available for [this release](https://bud.js.org/releases/tags/6-4). Please update to [6.4.2](https://bud.js.org/releases/6.4.2).
