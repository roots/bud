...
If you wish to limit generated values in `theme.json` to those included in `theme.extend`, you can now do so with an optional parameter added to `useTailwindFontFamily`, `useTailwindColors`, and `useTailwindFontSize`.
