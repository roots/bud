...
> [Read the release notes on bud.js.org](https://bud.js.org/releases/6.5.1).

<!--truncate-->

:::info Updates available

There are patches available for [this release](https://bud.js.org/releases/tags/6-5). Please update to [6.5.2](https://bud.js.org/releases/6.5.2).
