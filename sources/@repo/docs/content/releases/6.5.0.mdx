...
There are patches available for [this release](https://bud.js.org/releases/tags/6-5). Please update to [6.5.1](https://bud.js.org/releases/6.5.1).

:::

As always, [release notes also available on bud.js.org](https://bud.js.org/releases/6.5.0/).
