...
If you want to add your own extensions after **bud.js** has bootstrapped, you can do so using [bud.use](/reference/bud.use).
...
In addition to supporting ad-hoc extensions, [bud.use](/reference/bud.use) supports any off-the-shelf webpack plugin:
