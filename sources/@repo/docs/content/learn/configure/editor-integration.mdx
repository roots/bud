...
You can enhance your experience in vscode and other editors using a `jsconfig.json` or `tsconfig.json` file.
...
```json title=tsconfig.json
{
  ...
  "compilerOptions": {
    ...
    "types": ["@roots/bud", "@roots/bud-postcss", "@roots/bud-swc"]
  },
  "files": ["bud.config.js"],
  "include": ["src"],
