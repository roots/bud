...
The development server can be configured with [bud.serve](/reference/bud.serve).
...
The development server can be [configured to use SSL](/reference/bud.serve#ssl).
...
You can use [bud.proxy](/reference/bud.proxy) to proxy an existing server.
