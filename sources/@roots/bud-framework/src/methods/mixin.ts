...
/**
 * Generic type defining the {@link Service.bindClass} map of classes to {@link Bud} property keys
 *
 * @public
 */
...
/**
 * Bind a {@link Class} to the {@link Bud}.
 *
 * @remarks
 ...
 * ```
 *
 * @typeParam Binding - Map of {@link Bud} keys to classes
 *
 * @public
 * @decorator `@bind`
 */
