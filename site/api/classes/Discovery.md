...
- [`Service`](Service.md)<`Contract`[``"repository"``]\>
...
[packages/@roots/bud/src/services/Discovery/index.ts:19](https://github.com/roots/bud/blob/a5a389b4/packages/@roots/bud/src/services/Discovery/index.ts#L19)
...
[packages/@roots/bud/src/services/Discovery/index.ts:21](https://github.com/roots/bud/blob/a5a389b4/packages/@roots/bud/src/services/Discovery/index.ts#L21)
...
Contract.resolveFrom

#### Defined in

packages/@roots/bud-framework/types/Discovery.d.ts:27
...
[packages/@roots/bud/src/services/Discovery/index.ts:71](https://github.com/roots/bud/blob/a5a389b4/packages/@roots/bud/src/services/Discovery/index.ts#L71)
...
[packages/@roots/bud/src/services/Discovery/index.ts:52](https://github.com/roots/bud/blob/a5a389b4/packages/@roots/bud/src/services/Discovery/index.ts#L52)
...
Contract.hasPeerDependency

#### Defined in

[packages/@roots/bud/src/services/Discovery/index.ts:60](https://github.com/roots/bud/blob/a5a389b4/packages/@roots/bud/src/services/Discovery/index.ts#L60)
...
| Name | Type |
| :------ | :------ |
| `mutationFn` | (`value?`: `Repository`) => `Repository` |
...
[packages/@roots/bud/src/services/Discovery/index.ts:33](https://github.com/roots/bud/blob/a5a389b4/packages/@roots/bud/src/services/Discovery/index.ts#L33)
...
Contract.resolvePeers

#### Defined in

[packages/@roots/bud/src/services/Discovery/index.ts:103](https://github.com/roots/bud/blob/a5a389b4/packages/@roots/bud/src/services/Discovery/index.ts#L103)
