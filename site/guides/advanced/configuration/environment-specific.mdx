...
description: Learn how to use multiple configuration files to target different environments
...
- Specifies that in `production` mode the entrypoint should be hashed and minfied.
