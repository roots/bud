...
import Example from '!!raw-loader!@site/../examples/babel/bud.config.js'
...
Out of the box [@roots/bud-babel](/extensions/bud.babel) comes preconfigured with:
...
This config comes from [our Babel example on Github](https://github.com/roots/bud/tree/stable/examples/babel), if you want to see it in context.
