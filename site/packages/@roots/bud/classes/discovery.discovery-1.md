---
id: "discovery.discovery-1"
title: "Class: Discovery"
sidebar_label: "Discovery.Discovery"
custom_edit_url: null
---

[Discovery](../modules/discovery.md).Discovery
...
packages/@roots/bud/types/services/Discovery/index.d.ts:3
...
packages/@roots/bud/types/services/Discovery/index.d.ts:4
...
• `Private` **setRequired**: `any`

#### Defined in

packages/@roots/bud/types/services/Discovery/index.d.ts:25
...
▸ **discover**(`type`): [`Discovery`](discovery.discovery-1.md)
...
[`Discovery`](discovery.discovery-1.md)
...
packages/@roots/bud/types/services/Discovery/index.d.ts:23

___

### each

▸ **each**(`key`, `callFn`): [`Discovery`](discovery.discovery-1.md)
...
▸ **every**(`fn`): [`Discovery`](discovery.discovery-1.md)
...
▸ **fromEntries**(`entries`): [`Discovery`](discovery.discovery-1.md)
...
packages/@roots/bud/types/services/Discovery/index.d.ts:32
...
packages/@roots/bud/types/services/Discovery/index.d.ts:35
...
packages/@roots/bud/types/services/Discovery/index.d.ts:31
...
packages/@roots/bud/types/services/Discovery/index.d.ts:27

___

### merge

▸ **merge**(`key`, `value`): [`Discovery`](discovery.discovery-1.md)
...
▸ **mergeStore**(`values`): [`Discovery`](discovery.discovery-1.md)
...
▸ **mutate**(`key`, `mutationFn`): [`Discovery`](discovery.discovery-1.md)
...
▸ **mutateStore**(`mutationFn`): [`Discovery`](discovery.discovery-1.md)
...
packages/@roots/bud/types/services/Discovery/index.d.ts:22
...
packages/@roots/bud/types/services/Discovery/index.d.ts:26
...
▸ **remove**(`key`): [`Discovery`](discovery.discovery-1.md)
...
packages/@roots/bud/types/services/Discovery/index.d.ts:24

___

### set

▸ **set**(`key`, `value`): [`Discovery`](discovery.discovery-1.md)
...
▸ **setStore**(`repository`): [`Discovery`](discovery.discovery-1.md)
