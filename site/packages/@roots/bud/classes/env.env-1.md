...
packages/@roots/bud/types/services/Env/index.d.ts:3
...
packages/@roots/bud/types/services/Env/index.d.ts:4
...
packages/@roots/bud/types/services/Env/index.d.ts:8
...
▸ **each**(`key`, `callFn`): [`Env`](env.env-1.md)
...
▸ **fromEntries**(`entries`): [`Env`](env.env-1.md)
...
packages/@roots/bud/types/services/Env/index.d.ts:5
...
▸ **merge**(`key`, `value`): [`Env`](env.env-1.md)
...
▸ **mergeStore**(`values`): [`Env`](env.env-1.md)
...
▸ **mutate**(`key`, `mutationFn`): [`Env`](env.env-1.md)
...
▸ **mutateStore**(`mutationFn`): [`Env`](env.env-1.md)
...
▸ **set**(`key`, `value`): [`Env`](env.env-1.md)
...
▸ **setStore**(`repository`): [`Env`](env.env-1.md)
