...
▸ **each**(`key`, `callFn`): [`Api`](api.api-1.md)
...
▸ **fromEntries**(`entries`): [`Api`](api.api-1.md)
...
▸ **merge**(`key`, `value`): [`Api`](api.api-1.md)
...
▸ **mergeStore**(`values`): [`Api`](api.api-1.md)
...
▸ **mutate**(`key`, `mutationFn`): [`Api`](api.api-1.md)
...
▸ **mutateStore**(`mutationFn`): [`Api`](api.api-1.md)
...
▸ **set**(`key`, `value`): [`Api`](api.api-1.md)
...
▸ **setStore**(`repository`): [`Api`](api.api-1.md)
