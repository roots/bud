---
id: "dependencies.dependencies-1"
title: "Class: Dependencies"
sidebar_label: "Dependencies.Dependencies"
custom_edit_url: null
---

[Dependencies](../modules/dependencies.md).Dependencies
...
packages/@roots/bud/types/services/Dependencies/Base.d.ts:5
...
packages/@roots/bud/types/services/Dependencies/Base.d.ts:4
...
▸ **each**(`key`, `callFn`): [`Dependencies`](dependencies.dependencies-1.md)
...
[`Dependencies`](dependencies.dependencies-1.md)
...
▸ **every**(`fn`): [`Dependencies`](dependencies.dependencies-1.md)
...
▸ **fromEntries**(`entries`): [`Dependencies`](dependencies.dependencies-1.md)
...
| Name | Type |
| :------ | :------ |
| `deps` | { `name`: `string` ; `source`: `string` ; `type`: ``"devDependencies"`` \| ``"dependencies"`` ; `ver`: `string`  }[] |
...
packages/@roots/bud/types/services/Dependencies/index.d.ts:6
...
▸ **merge**(`key`, `value`): [`Dependencies`](dependencies.dependencies-1.md)
...
▸ **mergeStore**(`values`): [`Dependencies`](dependencies.dependencies-1.md)
...
▸ **mutate**(`key`, `mutationFn`): [`Dependencies`](dependencies.dependencies-1.md)
...
▸ **mutateStore**(`mutationFn`): [`Dependencies`](dependencies.dependencies-1.md)
...
packages/@roots/bud/types/services/Dependencies/index.d.ts:12
...
packages/@roots/bud/types/services/Dependencies/index.d.ts:3
...
packages/@roots/bud/types/services/Dependencies/index.d.ts:4
...
▸ **remove**(`key`): [`Dependencies`](dependencies.dependencies-1.md)
...
▸ **set**(`key`, `value`): [`Dependencies`](dependencies.dependencies-1.md)
...
▸ **setStore**(`repository`): [`Dependencies`](dependencies.dependencies-1.md)
...
packages/@roots/bud/types/services/Dependencies/index.d.ts:5
