...
packages/@roots/bud-cache/types/index.d.ts:3
...
packages/@roots/bud-cache/types/index.d.ts:5
...
packages/@roots/bud-cache/types/index.d.ts:8
...
packages/@roots/bud-cache/types/index.d.ts:7

___

### each

▸ **each**(`key`, `callFn`): [`Cache`](cache.cache-1.md)
...
▸ **every**(`fn`): [`Cache`](cache.cache-1.md)
...
▸ **fromEntries**(`entries`): [`Cache`](cache.cache-1.md)
...
packages/@roots/bud-cache/types/index.d.ts:9
...
▸ **merge**(`key`, `value`): [`Cache`](cache.cache-1.md)
...
▸ **mergeStore**(`values`): [`Cache`](cache.cache-1.md)
...
▸ **mutate**(`key`, `mutationFn`): [`Cache`](cache.cache-1.md)
...
▸ **mutateStore**(`mutationFn`): [`Cache`](cache.cache-1.md)
...
packages/@roots/bud-cache/types/index.d.ts:4
...
▸ **remove**(`key`): [`Cache`](cache.cache-1.md)
...
▸ **set**(`key`, `value`): [`Cache`](cache.cache-1.md)
...
▸ **setStore**(`repository`): [`Cache`](cache.cache-1.md)
...
packages/@roots/bud-cache/types/index.d.ts:6
