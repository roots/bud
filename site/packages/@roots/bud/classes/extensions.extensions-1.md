...
sidebar_label: "Extensions.Extensions"
...
packages/@roots/bud/types/services/Extensions/index.d.ts:3
...
▪ [x: `string`]: [`WebpackConfigDumpPlugin`](../modules/webpackconfigdumpplugin.md) \| [`DefineWebpackPlugin`](../modules/definewebpackplugin.md) \| [`HotModuleReplacementPlugin`](../modules/hotmodulereplacementplugin.md) \| [`WebpackManifestPlugin`](../modules/webpackmanifestplugin.md) \| [`CleanWebpackPlugin`](../modules/cleanwebpackplugin.md) \| [`CopyWebpackPlugin`](../modules/copywebpackplugin.md) \| [`CssMinimizerWebpackPlugin`](../modules/cssminimizerwebpackplugin.md) \| [`IgnoreEmitWebpackPlugin`](../modules/ignoreemitwebpackplugin.md) \| [`MiniCssExtractPlugin`](../modules/minicssextractplugin.md) \| [`WebpackProvidePlugin`](../modules/webpackprovideplugin.md)
...
packages/@roots/bud/types/services/Extensions/index.d.ts:4
...
packages/@roots/bud-extensions/types/Extensions/index.d.ts:8
...
packages/@roots/bud-extensions/types/Extensions/index.d.ts:5
...
packages/@roots/bud-extensions/types/Extensions/index.d.ts:7
...
▸ **each**(`key`, `callFn`): [`Extensions`](extensions.extensions-1.md)
...
▸ **every**(`fn`): [`Extensions`](extensions.extensions-1.md)
...
▸ **fromEntries**(`entries`): [`Extensions`](extensions.extensions-1.md)
...
packages/@roots/bud-extensions/types/Extensions/index.d.ts:9

___

### merge

▸ **merge**(`key`, `value`): [`Extensions`](extensions.extensions-1.md)
...
▸ **mergeStore**(`values`): [`Extensions`](extensions.extensions-1.md)
...
▸ **mutate**(`key`, `mutationFn`): [`Extensions`](extensions.extensions-1.md)
...
▸ **mutateStore**(`mutationFn`): [`Extensions`](extensions.extensions-1.md)
...
packages/@roots/bud-extensions/types/Extensions/index.d.ts:4
...
Base.registerExtension

#### Defined in

packages/@roots/bud-extensions/types/Extensions/index.d.ts:6
...
▸ **remove**(`key`): [`Extensions`](extensions.extensions-1.md)
...
▸ **set**(`key`, `value`): [`Extensions`](extensions.extensions-1.md)
...
▸ **setStore**(`repository`): [`Extensions`](extensions.extensions-1.md)
