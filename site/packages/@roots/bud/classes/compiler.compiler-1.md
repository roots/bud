---
id: "compiler.compiler-1"
title: "Class: Compiler"
sidebar_label: "Compiler.Compiler"
...
▸ **each**(`key`, `callFn`): [`Compiler`](compiler.compiler-1.md)
...
▸ **every**(`fn`): [`Compiler`](compiler.compiler-1.md)
...
▸ **fromEntries**(`entries`): [`Compiler`](compiler.compiler-1.md)
...
▸ **merge**(`key`, `value`): [`Compiler`](compiler.compiler-1.md)
...
▸ **mergeStore**(`values`): [`Compiler`](compiler.compiler-1.md)
...
▸ **mutate**(`key`, `mutationFn`): [`Compiler`](compiler.compiler-1.md)
...
▸ **mutateStore**(`mutationFn`): [`Compiler`](compiler.compiler-1.md)
...
▸ **remove**(`key`): [`Compiler`](compiler.compiler-1.md)
...
▸ **set**(`key`, `value`): [`Compiler`](compiler.compiler-1.md)
...
▸ **setStore**(`repository`): [`Compiler`](compiler.compiler-1.md)
