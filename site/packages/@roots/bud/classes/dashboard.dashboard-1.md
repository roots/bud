...
sidebar_label: "Dashboard.Dashboard"
...
packages/@roots/bud-dashboard/types/Dashboard/index.d.ts:5
...
packages/@roots/bud-dashboard/types/Dashboard/index.d.ts:4
...
▸ **each**(`key`, `callFn`): [`Dashboard`](dashboard.dashboard-1.md)
...
▸ **every**(`fn`): [`Dashboard`](dashboard.dashboard-1.md)
...
▸ **fromEntries**(`entries`): [`Dashboard`](dashboard.dashboard-1.md)
...
▸ **merge**(`key`, `value`): [`Dashboard`](dashboard.dashboard-1.md)
...
▸ **mergeStore**(`values`): [`Dashboard`](dashboard.dashboard-1.md)
...
▸ **mutate**(`key`, `mutationFn`): [`Dashboard`](dashboard.dashboard-1.md)
...
▸ **mutateStore**(`mutationFn`): [`Dashboard`](dashboard.dashboard-1.md)
...
▸ **remove**(`key`): [`Dashboard`](dashboard.dashboard-1.md)
...
▸ **set**(`key`, `value`): [`Dashboard`](dashboard.dashboard-1.md)
...
▸ **setStore**(`repository`): [`Dashboard`](dashboard.dashboard-1.md)
