...
declare namespace hooks {
  export {useForceUpdate, useFormatter}
}
export {hooks}
 ...
 * @public
 */
declare const Main: ({children}: {children: any}) => JSX.Element
