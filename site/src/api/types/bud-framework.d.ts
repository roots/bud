...
declare abstract class Abstract_3 implements Peers.Interface {
    ...
    export declare namespace Framework {
        ...
        export interface Options {
            ...
            services?: Framework.Services;
            /**
             * Should only be used by the main {@link (Framework:class) | Framework} instance.
             *
             * This constructor option is used to determine if a given {@link (Framework:class) | Framework} instance
     ...
     *
     * @internalRemarks
     * Todo: move everything out of this namespace
     *
     * @internal
     */
