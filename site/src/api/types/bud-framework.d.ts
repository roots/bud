...
declare abstract class Abstract_3 implements Peers.Interface {
     ...
     * @public
     */
    declare function access<I = any>(this: Framework, value: Tapable | I): any;
     ...
     * @public
     */
    declare interface CompilerPlugin<Plugin = ApplyPlugin, Options = unknown> extends Module_2 {
        /**
    ...
    declare interface Controller {
         ...
         * @returns {@link Controller}
          ...
          * @public
          */
         declare type Extension_2<P = ApplyPlugin, O = unknown> = Module_2<O> | CompilerPlugin<P, O>;
         ...
         export declare abstract class Framework {
              ...
              * @public
              */
             declare interface Options_3 extends Partial<{
             ...
             declare function sequence<T = Framework>(this: Framework, fns: Callback_2[], value?: T): Framework;
