...
For a close look at this interface see [the API documentation for **hooks.on**](/@roots/bud-hooks/classes/hooks#on).
...
For a close look at this interface see [the API documentation for **hooks.filter**](/@roots/bud-hooks/classes/hooks#filter)
