...
var hot = function (options) {
    ...
    this.logger.info({ name: 'bud.api', options: options }, "bud.api.hot called");
    if ((options === null || options === void 0 ? void 0 : options.enabled) === false) {
        this.logger.info({ name: 'bud.api', options: options }, "bud.api.hot is not applicable to this build. skipping.");
        return this;
    }
    if (options === null || options === void 0 ? void 0 : options.watch) {
        this.logger.info({ name: 'bud.api', watch: options.watch }, "bud.api.hot set watch mode options to true");
    ...
    this.logger.info({ name: 'bud.api', devServerConfig: devServerConfig }, 'Updating dev server configuration');
