...
- [`@roots/bud-tailwindcss`](https://github.com/roots/bud/tree/main/workspaces/@roots/bud-tailwindcss) - updated to version 3.
- [`@roots/bud-sass`](https://github.com/roots/bud/tree/main/workspaces/@roots/bud-sass) - uses `postcss-scss` to avoid syntax conflicts between sass and postcss.
