module.exports = () => ({
  bail: true,
  cache: { type: 'memory' },
  context: '/Volumes/Samsung/Code/roots/bud/examples/node-api',
            ...
            use: [
              {
                ...
                options: {
                  root: '/Volumes/Samsung/Code/roots/bud/examples/node-api/src'
                }
              }
            ],
            exclude: /(node_modules|bower_components)/
  ...
  output: {
    ...
    filename: '[name].js',
    path: '/Volumes/Samsung/Code/roots/bud/examples/node-api/dist'
  },
  plugins: [
    {
      ...
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/node-api/dist'
    },
    {
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/node-api/.budfiles',
  ...
  recordsInputPath: '/Volumes/Samsung/Code/roots/bud/examples/node-api/.budfiles/bud-modules.json',
  recordsOutputPath: '/Volumes/Samsung/Code/roots/bud/examples/node-api/.budfiles/bud-modules.json',
  resolve: {
    extensions: [
      '.wasm',  '.mjs',
      '.js',    '.jsx',
