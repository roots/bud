module.exports = () => ({
  bail: true,
  cache: { type: 'memory' },
  context: '/Volumes/Samsung/Code/roots/bud/examples/imagemin',
            ...
            use: [
              {
                ...
                options: {
                  root: '/Volumes/Samsung/Code/roots/bud/examples/imagemin/src'
                }
              }
            ],
            exclude: /(node_modules|bower_components)/
  ...
  output: {
    ...
    filename: '[name].js',
    path: '/Volumes/Samsung/Code/roots/bud/examples/imagemin/dist'
  },
  plugins: [
    {
      ...
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/imagemin/dist'
    },
    {
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/imagemin/.budfiles',
    ...
    {
      userOptions: {
        template: '/Volumes/Samsung/Code/roots/bud/examples/imagemin/src/index.html',
  ...
  recordsInputPath: '/Volumes/Samsung/Code/roots/bud/examples/imagemin/.budfiles/bud-modules.json',
  recordsOutputPath: '/Volumes/Samsung/Code/roots/bud/examples/imagemin/.budfiles/bud-modules.json',
  resolve: {
    extensions: [
      '.wasm',  '.mjs',
      '.js',    '.jsx',
    ...
    modules: [
      ...
      '/Volumes/Samsung/Code/roots/bud/packages/@roots/bud-imagemin'
    ]
  }
})