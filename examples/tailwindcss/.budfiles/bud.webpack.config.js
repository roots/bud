module.exports = () => ({
  bail: true,
  cache: { type: 'memory' },
  context: '/Volumes/Samsung/Code/roots/bud/examples/tailwindcss',
            ...
            use: [
              {
                ...
                options: {
                  root: '/Volumes/Samsung/Code/roots/bud/examples/tailwindcss/src'
                }
              }
            ],
            exclude: /(node_modules|bower_components)/
            ...
            use: [
              {
                ...
                options: {
                  cacheDirectory: '/Volumes/Samsung/Code/roots/bud/examples/tailwindcss/.budfiles/cache/babel',
                  root: '/Volumes/Samsung/Code/roots/bud/examples/tailwindcss/src',
  ...
  output: {
    ...
    filename: '[name].js',
    path: '/Volumes/Samsung/Code/roots/bud/examples/tailwindcss/dist'
  },
  plugins: [
    {
      ...
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/tailwindcss/dist'
    },
    {
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/tailwindcss/.budfiles',
    ...
    },
    {
      userOptions: {
        ...
        window: { env: { PUBLIC_APP_TITLE: '"Create Bud App"' } },
    ...
    },
    {
      ...
      replacements: {
        PUBLIC_APP_TITLE: 'Create Bud App',
        APP_DESCRIPTION: 'Project description',
        APP_COLOR: '#fff'
      }
    }
  ],
  recordsInputPath: '/Volumes/Samsung/Code/roots/bud/examples/tailwindcss/.budfiles/bud-modules.json',
  recordsOutputPath: '/Volumes/Samsung/Code/roots/bud/examples/tailwindcss/.budfiles/bud-modules.json',
  resolve: {
    extensions: [
      '.wasm',  '.mjs',
      '.js',    '.jsx',
