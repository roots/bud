module.exports = () => ({
  bail: true,
  cache: { type: 'memory' },
  context: '/Volumes/Samsung/Code/roots/bud/examples/preset-recommend',
            ...
            use: [
              {
                ...
                options: {
                  root: '/Volumes/Samsung/Code/roots/bud/examples/preset-recommend/src'
                }
              }
            ],
            exclude: /(node_modules|bower_components)/
            ...
            use: [
              {
                ...
                options: {
                  cacheDirectory: '/Volumes/Samsung/Code/roots/bud/examples/preset-recommend/.budfiles/cache/babel',
                  root: '/Volumes/Samsung/Code/roots/bud/examples/preset-recommend/src',
  ...
  output: {
    ...
    filename: '[name].js',
    path: '/Volumes/Samsung/Code/roots/bud/examples/preset-recommend/dist'
  },
  plugins: [
    {
      ...
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/preset-recommend/dist'
    },
    {
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/preset-recommend/.budfiles',
  ...
  recordsInputPath: '/Volumes/Samsung/Code/roots/bud/examples/preset-recommend/.budfiles/bud-modules.json',
  recordsOutputPath: '/Volumes/Samsung/Code/roots/bud/examples/preset-recommend/.budfiles/bud-modules.json',
  resolve: {
    extensions: [
      '.wasm',  '.mjs',
      '.js',    '.jsx',
