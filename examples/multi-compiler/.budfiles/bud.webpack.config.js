module.exports = () => ({
  bail: true,
  cache: { type: 'memory' },
  context: '/Volumes/Samsung/Code/roots/bud/examples/multi-compiler',
  entry: { plugin: { import: [ 'plugin.js', 'plugin.css' ] } },
            ...
            use: [
              {
                ...
                options: {
                  root: '/Volumes/Samsung/Code/roots/bud/examples/multi-compiler/src'
                }
              }
            ],
            exclude: /(node_modules|bower_components)/
            ...
            use: [
              {
                ...
                options: {
                  cacheDirectory: '/Volumes/Samsung/Code/roots/bud/examples/multi-compiler/.budfiles/cache/babel',
                  root: '/Volumes/Samsung/Code/roots/bud/examples/multi-compiler/src',
  ...
  output: {
    ...
    filename: '[name].js',
    path: '/Volumes/Samsung/Code/roots/bud/examples/multi-compiler/dist/plugin'
  },
  plugins: [
    {
      ...
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/multi-compiler/dist/plugin'
    },
    {
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/multi-compiler/.budfiles',
  ...
  recordsInputPath: '/Volumes/Samsung/Code/roots/bud/examples/multi-compiler/.budfiles/plugin-modules.json',
  recordsOutputPath: '/Volumes/Samsung/Code/roots/bud/examples/multi-compiler/.budfiles/plugin-modules.json',
  resolve: {
    extensions: [
      '.wasm',  '.mjs',
      '.js',    '.jsx',
