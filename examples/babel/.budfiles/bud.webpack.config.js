module.exports = () => ({
  bail: true,
  cache: { type: 'memory' },
  context: '/Volumes/Samsung/Code/roots/bud/examples/babel',
  entry: { app: { import: [ 'app.js', 'demo.js', 'foo.css', 'global.css' ] } },
            ...
            use: [
              {
                ...
                options: {
                  root: '/Volumes/Samsung/Code/roots/bud/examples/babel/src'
                }
              }
            ],
            exclude: /(node_modules|bower_components)/
            ...
            use: [
              {
                ...
                options: {
                  cacheDirectory: '/Volumes/Samsung/Code/roots/bud/examples/babel/.budfiles/cache/babel',
                  root: '/Volumes/Samsung/Code/roots/bud/examples/babel/src',
  ...
  output: {
    ...
    filename: '[name].js',
    path: '/Volumes/Samsung/Code/roots/bud/examples/babel/dist'
  },
  plugins: [
    {
      ...
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/babel/dist'
    },
    {
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/babel/.budfiles',
  ...
  recordsInputPath: '/Volumes/Samsung/Code/roots/bud/examples/babel/.budfiles/bud-modules.json',
  recordsOutputPath: '/Volumes/Samsung/Code/roots/bud/examples/babel/.budfiles/bud-modules.json',
  resolve: {
    extensions: [
      '.wasm',  '.mjs',
      '.js',    '.jsx',
