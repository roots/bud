module.exports = () => ({
  bail: true,
  cache: { type: 'memory' },
  context: '/Volumes/Samsung/Code/roots/bud/examples/postcss',
  entry: { app: { import: [ 'app.css' ] } },
            ...
            use: [
              {
                ...
                options: {
                  root: '/Volumes/Samsung/Code/roots/bud/examples/postcss/src'
                }
              }
            ],
            exclude: /(node_modules|bower_components)/
            ...
            use: [
              {
                ...
                options: {
                  cacheDirectory: '/Volumes/Samsung/Code/roots/bud/examples/postcss/.budfiles/cache/babel',
                  root: '/Volumes/Samsung/Code/roots/bud/examples/postcss/src',
  ...
  output: {
    ...
    filename: '[name].js',
    path: '/Volumes/Samsung/Code/roots/bud/examples/postcss/dist'
  },
  plugins: [
    {
      ...
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/postcss/dist'
    },
    {
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/postcss/.budfiles',
  ...
  recordsInputPath: '/Volumes/Samsung/Code/roots/bud/examples/postcss/.budfiles/bud-modules.json',
  recordsOutputPath: '/Volumes/Samsung/Code/roots/bud/examples/postcss/.budfiles/bud-modules.json',
  resolve: {
    extensions: [
      '.wasm',  '.mjs',
      '.js',    '.jsx',
