module.exports = () => ({
  bail: true,
  cache: { type: 'memory' },
  context: '/Volumes/Samsung/Code/roots/bud/examples/emotion',
            ...
            use: [
              {
                ...
                options: {
                  root: '/Volumes/Samsung/Code/roots/bud/examples/emotion/src'
                }
              }
            ],
            exclude: /(node_modules|bower_components)/
            ...
            use: [
              {
                ...
                options: {
                  cacheDirectory: '/Volumes/Samsung/Code/roots/bud/examples/emotion/.budfiles/cache/babel',
                  root: '/Volumes/Samsung/Code/roots/bud/examples/emotion/src',
                  presets: [
                    [ '@babel/preset-env' ],
                    [ '@babel/preset-react' ]
  ...
  output: {
    ...
    filename: '[name].js',
    path: '/Volumes/Samsung/Code/roots/bud/examples/emotion/dist'
  },
  plugins: [
    {
      ...
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/emotion/dist'
    },
    {
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/emotion/.budfiles',
  ...
  recordsInputPath: '/Volumes/Samsung/Code/roots/bud/examples/emotion/.budfiles/bud-modules.json',
  recordsOutputPath: '/Volumes/Samsung/Code/roots/bud/examples/emotion/.budfiles/bud-modules.json',
  resolve: {
    extensions: [
      '.wasm',  '.mjs',
      '.js',    '.jsx',
    ...
    modules: [
      ...
      '/Volumes/Samsung/Code/roots/bud/packages/@roots/bud-emotion',
