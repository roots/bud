        ...
        oneOf: [
          ...
          },
          {
            ...
            use: [
              {
                loader:
                  '/Volumes/Samsung/Code/roots/bud/node_modules/resolve-url-loader/index.js',
                options: {
          ...
          },
          {
            ...
            use: [
              {
                loader:
                  '/Volumes/Samsung/Code/roots/bud/node_modules/html-loader/dist/cjs.js',
              },
            ],
          },
          {
            ...
            use: [
              {
                loader:
                  '/Volumes/Samsung/Code/roots/bud/node_modules/csv-loader/index.js',
              },
            ],
          },
          {
            ...
            use: [
              {
                loader:
                  '/Volumes/Samsung/Code/roots/bud/node_modules/xml-loader/index.js',
              },
            ],
          },
          {test: /\.toml$/, type: 'json'},
          ...
          {test: /\.json5$/, type: 'json'},
          {
            ...
            use: [
              {
                loader:
                  '/Volumes/Samsung/Code/roots/bud/node_modules/mini-css-extract-plugin/dist/loader.js',
              },
              {
                loader:
                  '/Volumes/Samsung/Code/roots/bud/node_modules/css-loader/dist/cjs.js',
                options: {importLoaders: 1},
              },
              {
                loader:
                  '/Volumes/Samsung/Code/roots/bud/node_modules/postcss-loader/dist/cjs.js',
                options: {
                  postcssOptions: {
                    plugins: [
          ...
          },
          {
            ...
            use: [
              {
                loader:
                  '/Volumes/Samsung/Code/roots/bud/node_modules/babel-loader/lib/index.js',
                options: {
                  cacheDirectory:
                    '/Volumes/Samsung/Code/roots/bud/examples/sage/storage/bud/cache/babel',
                  root: '/Volumes/Samsung/Code/roots/bud/examples/sage/resources',
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        cache: true,
        cacheLocation:
          '/Volumes/Samsung/Code/roots/bud/examples/sage/storage/bud/cache/eslint.json',
    ...
    },
    {
      ...
      startTime: 1629787963405,
    },
  ],
  recordsInputPath:
    '/Volumes/Samsung/Code/roots/bud/examples/sage/storage/bud/bud-modules.json',
  recordsOutputPath:
    '/Volumes/Samsung/Code/roots/bud/examples/sage/storage/bud/bud-modules.json',
  resolve: {
    alias: {
      ...
      '@images':
        '/Volumes/Samsung/Code/roots/bud/examples/sage/resources/images',
      '@scripts':
        '/Volumes/Samsung/Code/roots/bud/examples/sage/resources/scripts',
      '@styles':
        '/Volumes/Samsung/Code/roots/bud/examples/sage/resources/styles',
    },
    extensions: [
      '.wasm',
      '.mjs',
