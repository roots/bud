module.exports = () => ({
  bail: true,
  cache: { type: 'memory' },
  context: '/Volumes/Samsung/Code/roots/bud/examples/vue',
  entry: { app: { import: [ 'app.vue' ] } },
            ...
            use: [
              {
                ...
                options: {
                  root: '/Volumes/Samsung/Code/roots/bud/examples/vue/src'
                }
              }
            ],
            exclude: /(node_modules|bower_components)/
  ...
  output: {
    ...
    filename: '[name].js',
    path: '/Volumes/Samsung/Code/roots/bud/examples/vue/dist'
  },
  plugins: [
    {
      ...
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/vue/dist'
    },
    {
      outputPath: '/Volumes/Samsung/Code/roots/bud/examples/vue/.budfiles',
  ...
  recordsInputPath: '/Volumes/Samsung/Code/roots/bud/examples/vue/.budfiles/bud-modules.json',
  recordsOutputPath: '/Volumes/Samsung/Code/roots/bud/examples/vue/.budfiles/bud-modules.json',
  resolve: {
