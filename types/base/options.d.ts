export namespace options {
    ...
    export namespace uglify {
        export const cache: boolean;
        export function chunkFilter({ name }: {
            name: any;
        }): boolean;
        export const extractComments: boolean;
        export const parallel: boolean;
        export namespace uglifyOptions {
            export namespace output {
                export const beautify: boolean;
            }
            const compress_1: boolean;
            export { compress_1 as compress };
            export namespace mangle {
                export const toplevel: boolean;
            }
        }
    }
