 ...
 */
var pluginControllerFactory = function (bud) {
  return {
    /**
    ...
    bindPluginProps: function () {
      ...
      this.ensurePluginProp('call', function (
        name,
        params,
      ) {
    ...
    mergePluginOptions: function () {
      ...
      if (this.boundValue) {
        ...
        this.plugin.options = __assign(
          __assign({}, this.plugin.options),
          this.boundValue,
        )
      }
    ...
    doPluginHook: function (hook) {
      ...
      ;(_a = this.bud.hooks).call.apply(
        _a,
        __spreadArrays(
          [hook + '_bud_plugin_' + this.name, this.plugin],
          params,
        ),
      )
    },
