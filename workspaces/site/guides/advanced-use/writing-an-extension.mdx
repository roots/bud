...
import ModuleDefinition from '!!raw-loader!@site/../workspaces/@roots/bud-framework/src/Extensions/Extension/module.interface.ts'

import Index from '!!raw-loader!@site/../workspaces/@roots/bud-tailwindcss/src/index.ts'
import Extension from '!!raw-loader!@site/../workspaces/@roots/bud-tailwindcss/src/tailwind.extension.ts'
import Config from '!!raw-loader!@site/../workspaces/@roots/bud-tailwindcss/src/bud.tailwind.ts'
