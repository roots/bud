 ...
 */
const pluginControllerFactory: BudConstructor = (bud: bud): BudPluginController => ({
  /**
   ...
   * @return   {BudPluginController}
   */
  new: function (name: string, plugin: object): BudPluginController {
    this.name = name
    this.plugin = plugin
   ...
   * @return   {void}
   */
  ensurePluginProp: function (pluginProp: string, fallback: any): void {
